...
type TabId =
  "popular" | "software-development" | "marketing" | "office" | "trading";
...
export default function TalentMarketModal({ open, onClose }: Props) {
  ...
  const tabs: Array<{ id: TabId; label: string }> = [
    {
      id: "popular",
      label: t("talentMarket.tabPopular", isChinese ? "热门推荐" : "Popular"),
    },
    {
      id: "software-development",
      label: t(
        "talentMarket.tabSWE",
        isChinese ? "软件开发" : "Software Development",
      ),
    },
    {
      id: "marketing",
      label: t("talentMarket.tabMarketing", isChinese ? "营销" : "Marketing"),
    },
    {
      id: "office",
      label: t("talentMarket.tabOffice", isChinese ? "办公通用" : "Office"),
    },
    {
      id: "trading",
      label: t("talentMarket.tabTrading", isChinese ? "交易投资" : "Trading"),
    },
  ];
      ...
      >
        ...
        >
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            >
              {t(
                "talentMarket.subtitle",
                isChinese
                  ? "挑选一位专业成员加入你的公司"
                  : "Pick a professional to join your company",
              )}
            </p>
          </div>
          {/* Search box */}
          ...
          >
            ...
            <input
              ...
              aria-label={t(
                "talentMarket.searchLabel",
                isChinese ? "搜索 Agent" : "Search agents",
              )}
            />
            {searchQuery && (
              <button
        ...
        <div
          role="tablist"
          aria-label={t(
            "talentMarket.tabsAria",
            isChinese ? "分类筛选" : "Category filters",
          )}
          style={{
            display: "flex",
            padding: "0 28px",
        ...
        >
          ...
          {!isLoading && visibleTemplates.length === 0 && (
            ...
            >
              {isSearching
                ? t(
                    "talentMarket.emptySearch",
                    isChinese
                      ? `没有匹配 "${trimmedQuery}" 的 Agent`
          ...
          {!isLoading &&
            visibleTemplates.map((tpl: Template) => (
              <TemplateCard
                key={tpl.id}
                tpl={tpl}
                hiring={false}
        ...
        >
          {t(
            ...
            isChinese
              ? "点击聘用·可随时在设置中调整"
              : "Hire now · adjust anything in settings later",
          )}
        </div>
      </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: "pointer",
        background:
          "linear-gradient(135deg, rgba(255,255,255,0.97) 0%, rgba(255,255,255,0.92) 54%, rgba(249,246,238,0.82) 100%)",
    ...
    >
      ...
      >
        {t(
          "talentMarket.customTitle",
          isChinese ? "自建 Agent" : "Build custom",
        )}
      </div>
      <div
        style={{
      ...
      >
        {t(
          "talentMarket.customDescription",
          isChinese
      ...
      >
        ...
        <span>
          {t(
            "talentMarket.externalAgentHint",
            isChinese
