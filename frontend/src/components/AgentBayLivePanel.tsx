...
export default function AgentBayLivePanel({
  liveState,
  visible,
  onToggle,
  agentId,
        ...
        {agentId &&
          ...
          (activeTab === "browser" || activeTab === "desktop") && (
            <button
              ...
              title={
                activeTab === "desktop"
                  ? "Take Control — manually interact with the cloud desktop"
                  : "Take Control — manually interact with the browser"
              }
            >
              <svg
                width="13"
      ...
      <div className="live-panel-content">
        ...
        {((activeTab === "desktop" && !liveState.desktop) ||
          ...
          <div className="live-panel-empty">
            <span style={{ opacity: 0.5 }}>{TabIcons[activeTab]}</span>
            <span>
              Waiting for {tabLabels[activeTab].toLowerCase()} activity...
            </span>
          </div>
        )}
      </div>
      ...
      {showTakeControl && agentId && sessionId && (
        <TakeControlPanel
          ...
          onLastScreenshot={(dataUri) => {
            ...
            console.log(
              "[LivePanel] Received last screenshot from TC, size:",
              dataUri.length,
              "env:",
              env,
              "onLiveUpdate:",
