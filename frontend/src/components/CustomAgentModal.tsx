...
export default function CustomAgentModal({
  ...
  const [createdExternal, setCreatedExternal] = useState<CreatedAgent | null>(
    null,
  );
              ...
              >
                <Field label={t("customAgentModal.name")} required>
                  <input
                    ...
                    aria-describedby={
                      nameErrorText ? "custom-agent-name-error" : undefined
                    }
                    style={{ width: "100%" }}
                  />
                  {nameErrorText ? (
                      ...
                      >
                        {enabledModels.map((m) => (
                          <option key={m.id} value={m.id}>
                            ...
                            {myTenant?.default_model_id === m.id
                              ? ` · ${t("customAgentModal.defaultModel")}`
                              : ""}
                          </option>
                        ))}
                      </select>
              ...
              {mode === "native" ? (
                <>
                  <span
                    ...
                    style={{
                      display: "inline-flex",
                      cursor: nativeHasNoModel ? "not-allowed" : undefined,
                    }}
                  >
                    <button
                      className="btn btn-secondary"
                      ...
                      style={{
                        pointerEvents: nativeHasNoModel ? "none" : undefined,
                      }}
                  ...
                  >
                    ...
                    >
                      {busy
                        ? t("customAgentModal.creating")
                        : t("customAgentModal.chatNow")}
                    </button>
                  </span>
                </>
              ) : (
                ...
                >
                  {busy
                    ? t("customAgentModal.creating")
                    : t("customAgentModal.createConnection")}
                </button>
              )}
            </div>
          </>
  ...
  return (
    ...
    >
      <IconAlertTriangle
        size={17}
        stroke={1.8}
        style={{ marginTop: "1px", color: "#b45309", flexShrink: 0 }}
      />
      <div style={{ minWidth: 0 }}>
        ...
        >
          ...
          {!canManageModels && allowExternalHint ? (
            <span> {t("customAgentModal.noModelsExternalHint")}</span>
          ) : null}
        </div>
        {canManageModels ? (
          <button
    ...
    <>
      ...
      <div style={{ padding: "8px 26px 20px", overflowY: "auto" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            {setupInstruction || t("customAgentModal.noKeyReturned")}
          </pre>
          {setupInstruction && (
            <LinearCopyButton
              className="btn btn-ghost"
