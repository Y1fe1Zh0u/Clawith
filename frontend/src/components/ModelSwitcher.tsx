...
export default function ModelSwitcher({
  ...
  useLayoutEffect(() => {
    ...
    const recompute = () => {
      ...
      const placeAbove =
        spaceAbove >= PREFERRED_HEIGHT || spaceAbove >= spaceBelow;
    ...
    <div ref={ref} style={{ position: "relative", display: "inline-block" }}>
      <button
        ...
        style={{
          ...
          borderRadius: "999px",
          background:
            open || hovered ? "var(--bg-elevated)" : "var(--bg-primary)",
      ...
      >
        ...
        >
          {selected
            ? labelFor(selected)
            : t("chat.modelSwitcher.none", "No model")}
        </span>
        <IconChevronDown
          size={13}
          stroke={2}
