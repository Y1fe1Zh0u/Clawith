...
} from "./enterprise-settings/components/CompanyInfoEditors";
        ...
        {PRESET_COLORS.map((c) => (
          <div
            ...
            style={{
              ...
              outline:
                currentColor === c.hex ? "2px solid var(--bg-primary)" : "none",
...
export default function EnterpriseSettings() {
  ...
  >("all");
  const [expandedToolCategories, setExpandedToolCategories] = useState<
    Set<string>
  >(() => new Set());
  ...
  const resolveApproval = useMutation({
    ...
    onSuccess: () =>
      qc.invalidateQueries({ queryKey: ["approvals", selectedTenantId] }),
  });
      ...
      <div>
            ...
            {stats && (
              <div style={{ display: "flex", gap: "24px", marginTop: "8px" }}>
                <span className="badge badge-info">
                  {t("enterprise.stats.users", { count: stats.total_users })}
                </span>
                <span className="badge badge-success">
                  {t("enterprise.stats.runningAgents", {
                ...
                {stats.pending_approvals > 0 && (
                  <span className="badge badge-warning">
                    {stats.pending_approvals} {t("enterprise.tabs.approvals")}
                  </span>
                )}
              </div>
            )}
        ...
        <div className="tabs">
          {(
            ...
            >
              {tab === "quotas"
                ? t("enterprise.tabs.quotas", "Quotas")
                : tab === "users"
                  ? t("enterprise.tabs.users", "Users")
                  : tab === "invites"
                    ? t("enterprise.tabs.invites", "Invitations")
                    : tab === "okr"
                      ? t("nav.okr", "OKR")
              ...
              >
                <div>
                  ...
                  <div
                    style={{ fontSize: "12px", color: "var(--text-tertiary)" }}
                  >
                    {a.agent_name || `Agent ${a.agent_id.slice(0, 8)}`} ·{" "}
                ...
                {a.status === "pending" ? (
                  <div style={{ display: "flex", gap: "8px" }}>
                    <button
                      ...
                      onClick={() =>
                        resolveApproval.mutate({ id: a.id, action: "approve" })
                      }
                    >
                      {t("common.confirm")}
                    </button>
                    <button
                      ...
                      onClick={() =>
                        resolveApproval.mutate({ id: a.id, action: "reject" })
                      }
                    >
                      Reject
                    </button>
                  ...
                  <span
                    className={`badge ${a.status === "approved" ? "badge-success" : "badge-error"}`}
                  >
                  ...
                  style={{
                    ...
                    background:
                      auditFilter === key
                        ...
                        : "transparent",
                    color:
                      auditFilter === key ? "#fff" : "var(--text-secondary)",
                    cursor: "pointer",
        ...
        {activeTab === "info" && (
          <div>
            ...
            >
              ...
              >
                {t(
                  "enterprise.companyIntro.description",
              ...
              >
                ...
                >
                  <IconBulb size={13} stroke={1.8} />{" "}
                  {t(
                    "enterprise.companyIntro.hint",
            ...
            >
              ...
              <EnterpriseKBBrowser
                onRefresh={() => setInfoRefresh((v: number) => v + 1)}
                refreshKey={infoRefresh}
              />
            </div>
            <ThemeColorPicker />
            ...
            >
              ...
              >
                {t(
                  "enterprise.deleteCompanyDesc",
                  "Permanently delete this company and all its data including agents, models, tools, and skills. This action cannot be undone.",
                )}
              </p>
              <button
                className="btn"
                onClick={async () => {
                  const ok = await dialog.confirm(
                    t(
                      "enterprise.deleteCompanyConfirm",
                      "Are you sure you want to delete this company and ALL its data? This cannot be undone.",
                    ),
                    {
                      title: t(
                        "enterprise.deleteCompanyTitle",
                        "Delete company",
                      ),
                      danger: true,
                      confirmLabel: t(
                        "enterprise.deleteCompanyConfirmButton",
                        "Permanently delete",
                      ),
                    },
                  );
        ...
        {activeTab === "quotas" && (
          <div>
            <h3 style={{ marginBottom: "4px" }}>
              {t("enterprise.quotas.defaultUserQuotas")}
            </h3>
            <p
              style={{
                fontSize: "12px",
            ...
            <div className="card" style={{ padding: "16px" }}>
              ...
              >
                {t("enterprise.quotas.conversationLimits")}
              </div>
              <div
                style={{
                  display: "grid",
              ...
              >
                <div className="form-group">
                  <label className="form-label">
                    {t("enterprise.quotas.messageLimit")}
                  </label>
                  <input
                    className="form-input"
                    type="number"
                  ...
                  >
                    {t("enterprise.quotas.maxMessagesPerPeriod")}
                  </div>
                </div>
                <div className="form-group">
                  <label className="form-label">
                    {t("enterprise.quotas.messagePeriod")}
                  </label>
                  <select
                    className="form-input"
                    ...
                    onChange={(e) =>
                      setQuotaForm({
                        ...quotaForm,
                        default_message_period: e.target.value,
                      })
                    }
                  >
                    <option value="permanent">
                      {t("enterprise.quotas.permanent")}
                    </option>
                    <option value="daily">
                      {t("enterprise.quotas.daily")}
                    </option>
                    <option value="weekly">
                      {t("enterprise.quotas.weekly")}
                    </option>
                    <option value="monthly">
                      {t("enterprise.quotas.monthly")}
                    </option>
                  </select>
                </div>
              </div>
              ...
              >
                {t("enterprise.quotas.agentLimits")}
              </div>
              <div
                style={{
                  display: "grid",
              ...
              >
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setQuotaForm({
                        ...quotaForm,
                        default_max_agents: Number(e.target.value),
                      })
                    }
                  />
                  <div
                  ...
                  >
                    {t("enterprise.quotas.agentsUserCanCreate")}
                  </div>
                </div>
                <div className="form-group">
                  <label className="form-label">
                    {t("enterprise.quotas.agentTTL")}
                  </label>
                  <select
                    className="form-input"
                    value={
                  ...
                  >
                    ...
                    <option value="custom">
                      {t("enterprise.quotas.customHours", "Custom hours")}
                    </option>
                  </select>
                  {quotaForm.default_agent_ttl_hours > 0 && (
                    <input
                      ...
                      onChange={(e) =>
                        setQuotaForm({
                          ...quotaForm,
                          default_agent_ttl_hours: Number(e.target.value),
                        })
                      }
                      style={{ marginTop: "8px" }}
                    />
                ...
                <div className="form-group">
                  <label className="form-label">
                    {t("enterprise.quotas.dailyLLMCalls")}
                  </label>
                  <input
                    className="form-input"
                    type="number"
                    ...
                    onChange={(e) =>
                      setQuotaForm({
                        ...quotaForm,
                        default_max_llm_calls_per_day: Number(e.target.value),
                      })
                    }
                  />
                  <div
                  ...
                  >
                    {t("enterprise.quotas.maxLLMCallsPerDay")}
                  </div>
                </div>
              </div>
              ...
              >
                <div className="form-group">
                  <label className="form-label">
                    {t("enterprise.quotas.minHeartbeatInterval")}
                  </label>
                  <input
                    className="form-input"
                    type="number"
                    ...
                    onChange={(e) =>
                      setQuotaForm({
                        ...quotaForm,
                        min_heartbeat_interval_minutes: Number(e.target.value),
                      })
                    }
                  />
                  <div
                  ...
                  >
                    {t("enterprise.quotas.minHeartbeatDesc")}
                  </div>
                </div>
              </div>
              ...
              >
                {t("enterprise.quotas.triggerLimits")}
              </div>
              <div
                style={{
                  display: "grid",
              ...
              >
                <div className="form-group">
                  <label className="form-label">
                    {t(
                      "enterprise.quotas.defaultMaxTriggers",
                      "Default Max Triggers",
                    )}
                  </label>
                  <input
                    className="form-input"
                    ...
                    onChange={(e) =>
                      setQuotaForm({
                        ...quotaForm,
                        default_max_triggers: Number(e.target.value),
                      })
                    }
                  />
                  <div
                  ...
                  >
                    {t(
                      "enterprise.quotas.defaultMaxTriggersDesc",
                      "Default trigger limit for new agents",
                    )}
                  </div>
                </div>
                <div className="form-group">
                  <label className="form-label">
                    {t(
                      "enterprise.quotas.minPollInterval",
                      "Min Poll Interval (min)",
                    )}
                  </label>
                  <input
                    className="form-input"
                    ...
                    onChange={(e) =>
                      setQuotaForm({
                        ...quotaForm,
                        min_poll_interval_floor: Number(e.target.value),
                      })
                    }
                  />
                  <div
                  ...
                  >
                    {t(
                      "enterprise.quotas.minPollIntervalDesc",
                      "Company-wide floor: agents cannot poll faster than this",
                    )}
                  </div>
                </div>
                <div className="form-group">
                  <label className="form-label">
                    {t(
                      "enterprise.quotas.maxWebhookRate",
                      "Max Webhook Rate (/min)",
                    )}
                  </label>
                  <input
                    className="form-input"
                    ...
                    onChange={(e) =>
                      setQuotaForm({
                        ...quotaForm,
                        max_webhook_rate_ceiling: Number(e.target.value),
                      })
                    }
                  />
                  <div
                  ...
                  >
                    {t(
                      "enterprise.quotas.maxWebhookRateDesc",
                      "Company-wide ceiling: max webhook hits per minute per agent",
                    )}
                  </div>
                </div>
              </div>
        ...
        {activeTab === "tools" && (
          <div>
            ...
            <div
              ...
              role="tablist"
              aria-label={t("enterprise.tools.sourceTabs", "Tool sources")}
            >
              {(
                [
                  ["global", t("enterprise.tools.globalTools")],
                  ["agent-installed", t("enterprise.tools.agentInstalled")],
                ] as const
              ).map(([key, label]) => (
                <button
                  key={key}
            ...
            {toolsView === "agent-installed" && (
              <div>
                ...
                >
                  {t("enterprise.tools.agentInstalledHint")}
                </p>
                            ...
                            return (
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    {renderCategoryIcon(meta.iconCategory, 15)}
                                  </span>
                                    ...
                                    >
                                      ...
                                      <button
                                        ...
                                        onClick={async () => {
                                          const ok = await dialog.confirm(
                                            t(
                                              "enterprise.tools.removeFromAgent",
                                              { name: row.tool_display_name },
                                            ),
                                            {
                                              title: "移除工具",
                                              danger: true,
            ...
            {toolsView === "global" && (
              <>
                ...
                >
                  ...
                  >
                    + {t("enterprise.tools.addMcpServer")}
                  </button>
                </div>
                  ...
                  >
                    ...
                    >
                      ...
                      {mcpForm.server_name && (
                        ...
                        >
                          <span>
                            Name: <strong>{mcpForm.server_name}</strong>
                          </span>
                          <span>
                            URL: <strong>{mcpForm.server_url}</strong>
                          </span>
                        </div>
                      )}
                      {!mcpForm.server_name && (
                        <div>
                          ...
                          >
                            {t("enterprise.tools.mcpServerName")}
                          </label>
                          <input
                            className="form-input"
                      ...
                      >
                        ...
                        <div>
                          - If your MCP server embeds the key in the URL (e.g.
                          Tavily uses{" "}
                          <code
                            style={{
                          ...
                          ), leave the field above blank.
                        </div>
                        <div>
                          - For servers that use <strong>Bearer token</strong>{" "}
                          auth, enter the key here. It is sent as{" "}
                          <code
                            style={{
                              background: "rgba(0,0,0,0.06)",
                              padding: "0 3px",
                        ...
                        <div>
                          - If both are provided, the API Key field takes
                          priority. All keys are stored encrypted.
                        </div>
                      </div>
                      ...
                      <div style={{ display: "flex", gap: "8px" }}>
                        ...
                        >
                          {mcpTesting
                            ? t("enterprise.tools.testing")
                            : t("enterprise.tools.testConnection")}
                        </button>
                        <button
                          className="btn btn-secondary"
                          onClick={() => {
                        ...
                        >
                          {mcpTestResult.ok ? (
                            <div>
                              ...
                              >
                                {t("enterprise.tools.connectionSuccess", {
                              ...
                              >
                                <button
                                  ...
                                  onClick={async () => {
                                    ...
                                    if (errors.length > 0) {
                                      await dialog.alert(
                                        `已导入 ${successCount}/${tools.length} 个工具`,
                                        {
                                          type: "warning",
                                          title: "部分导入失败",
                                          details: errors.join("\n"),
                                      ...
                                      toast.success(
                                        t(
                                          "common.dialog.partialImportSuccess",
                                          { count: successCount },
                                        ),
                                      );
                                    }
                                ...
                                >
                                  {t("enterprise.tools.importAll")}
                                </button>
                              </div>
                            </div>
                          ) : (
                            <div style={{ color: "var(--danger)" }}>
                              {t("enterprise.tools.connectionFailed")}:{" "}
                              {mcpTestResult.error}
                            </div>
                          )}
                        </div>
                ...
                {(() => {
                  ...
                  const matchesStatus = (tool: any) => {
                    ...
                    if (toolStatusFilter === "default")
                      return !!tool.is_default;
                    if (toolStatusFilter === "configured")
                      return hasMeaningfulConfig(tool.config);
                    return true;
                  };
                  ...
                  const hasFilters =
                    !!normalizedSearch || toolStatusFilter !== "all";
                      ...
                      >
                        <div style={{ minWidth: 0 }}>
                          ...
                          >
                            {tool.description}
                            {tool.mcp_server_name && (
                              <span> · {tool.mcp_server_name}</span>
                            )}
                          </div>
                        </div>
                        <div
                        ...
                        >
                          ...
                          {hasOwnConfig && (
                            <button
                              ...
                              title={t(
                                "enterprise.tools.configureSettings",
                                "Configure settings",
                              )}
                              onClick={async () => {
                          ...
                          {tool.type !== "builtin" && (
                            <button
                              ...
                              onClick={async () => {
                                const ok = await dialog.confirm(
                                  t("common.dialog.deleteToolConfirm", {
                                    name: tool.display_name,
                                  }),
                                  {
                                    title: t("common.dialog.deleteTool"),
                                    danger: true,
                                    confirmLabel: t(
                                      "common.confirmActions.deleteLabel",
                                    ),
                                  },
                                );
                                if (!ok) return;
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {expandedToolCategories.size >=
                          Object.keys(allGrouped).length
                      ...
                      {Object.entries(grouped)
                        ...
                        .map(([category, catTools]) => {
                          ...
                          const allEnabled =
                            ...
                            enabledCount === allCatTools.length;
                          const mixed =
                            enabledCount > 0 &&
                            enabledCount < allCatTools.length;
                          const expanded =
                              ...
                              >
                                ...
                                >
                                  ...
                                  <label
                                    ...
                                    title={`Enable/Disable all ${label} tools`}
                                  >
                                    <input
                                      type="checkbox"
                                      checked={allEnabled}
                                    ...
                                    />
                                    <span
                                      style={switchTrack(allEnabled, mixed)}
                                    >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          Updates all tools from this server at once
                        </span>
                      </div>
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditingMcpServer((s) =>
                                s ? { ...s, server_url: e.target.value } : null,
                              )
                            }
                          ...
                          >
                            Stored encrypted. For URL-embedded keys (e.g.
                            Tavily), include the key directly here.
                          </div>
                        </div>
                        <div>
                          <label
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setEditingMcpServer((s) =>
                                s ? { ...s, api_key: e.target.value } : null,
                              )
                            }
                          ...
                          >
                            ...
                            Takes priority over URL-embedded keys.
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <div>
                            - <strong>URL-embedded key</strong> (e.g. Tavily{" "}
                            <code
                              style={{
                                background: "rgba(0,0,0,0.06)",
                                padding: "0 3px",
                            ...
                            ): include in Server URL above, leave API Key blank.
                          </div>
                          <div>
                            - <strong>Bearer token</strong> auth: enter in the
                            API Key field. It is injected as an HTTP header on
                            every request — the URL stays clean.
                          </div>
                          <div>
                            - If both are present, the API Key field takes
                            priority over any URL-embedded value.
                          </div>
                        </div>
                      </div>
                      ...
                      >
                        <button
                          className="btn btn-secondary"
                          onClick={() => setEditingMcpServer(null)}
                        ...
                        <button
                          className="btn btn-primary"
                          disabled={
                            mcpServerSaving || !editingMcpServer.server_url
                          }
                          onClick={async () => {
                            ...
                            try {
                              await fetchJson("/tools/mcp-server", {
                                ...
                                body: JSON.stringify({
                                  ...
                                  api_key:
                                    editingMcpServer.api_key || undefined,
                        ...
                        >
                          {mcpServerSaving ? "Saving..." : "Save Changes"}
                        </button>
                      </div>
                    </div>
                  </div>
                ...
                {configCategory &&
                  GLOBAL_CATEGORY_CONFIG_SCHEMAS[configCategory] && (
                    <div
                      style={{
                        position: "fixed",
                        top: 0,
                      ...
                      >
                        ...
                        >
                          <div>
                            ...
                            >
                              Global configuration shared by all tools in this
                              category
                            </div>
                          </div>
                          <button
