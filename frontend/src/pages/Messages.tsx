...
export default function Messages() {
  ...
  const formatTime = (iso: string) => {
    ...
    if (diffMs < 3600000)
      return t("messages.minutesAgo", { count: Math.floor(diffMs / 60000) });
    if (diffMs < 86400000)
      return t("messages.hoursAgo", { count: Math.floor(diffMs / 3600000) });
        ...
        {messages.map((msg: any) => (
          <div
            ...
            style={{
              padding: "14px 16px",
              borderRadius: "8px",
              background: msg.read_at
                ? "transparent"
                : "rgba(224,238,238,0.06)",
              cursor: msg.read_at ? "default" : "pointer",
              borderLeft: msg.read_at
