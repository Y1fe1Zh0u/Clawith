        ...
        <div className="login-form-wrapper" style={{ maxWidth: "460px" }}>
          ...
          {hintResult && (
            ...
            >
              ...
              {t("auth.emailHintResult", "Email hint")}:{" "}
              <strong>{hintResult}</strong>
            </div>
          )}
          ...
          {!showHintForm ? (
            ...
            <form onSubmit={handleGetHint} className="login-form">
              ...
              <button
                className="login-submit"
                type="submit"
                disabled={loading || !usernameHint.trim()}
              >
                {loading ? (
                  <span className="login-spinner" />
                ) : (
                  t("auth.getEmailHint", "Get Email Hint")
                )}
              </button>
