        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              {searchQuery && (
                ...
                >
                  {isChinese
                    ? `${filtered.length} / ${users.length} 位用户`
          ...
          <div
            style={{
              display: "grid",
              gridTemplateColumns:
                "1.4fr 1.4fr 0.8fr 0.7fr 0.7fr 0.8fr 0.8fr 0.8fr 0.8fr 100px",
              gap: "10px",
              padding: "10px 16px",
              fontSize: "11px",
              fontWeight: 600,
          ...
          >
            ...
            <div>
              {t("enterprise.users.agents", isChinese ? "数字员工" : "Agents")}
            </div>
          ...
          {paged.map((user) => (
            <div key={user.id}>
              ...
              >
                ...
                <div>
                  {currentUser?.role &&
                  ["platform_admin", "org_admin"].includes(currentUser.role) &&
                ...
                <div>
                  ...
                  >
                    {editingUserId === user.id ? (
                      ...
                      <>
                        <IconEdit size={13} stroke={1.8} /> {t("common.edit")}
                      </>
                    )}
                  </button>
                </div>
                    ...
                    <div className="form-group">
                      ...
                      >
                        {t(
                          ...
                          isChinese ? "员工存活时长(h)" : "Agent TTL (hours)",
                        )}
                      </label>
                      <input
                        className="form-input"
