...
export default function Onboarding() {
  ...
  const mode = (searchParams.get("mode") === "join" ? "join" : "create") as
    "create" | "join";
    ...
    onboardingApi
      ...
      .then((status) => {
        ...
        if (
          ...
          status.personal_assistant_agent_id
        ) {
          navigate(`/agents/${status.personal_assistant_agent_id}/chat`, {
            replace: true,
          });
          return;
        }
      ...
      <AtlasFrame onToggleLang={toggleLang}>
        <div className="atlas-screen-center atlas-screen-pad">
          <h1 className="atlas-h1">
            {isZh ? "先创建或加入一家公司" : "Create or join a company first"}
          </h1>
          <button
          ...
          <div className="atlas-screen-form atlas-screen-form--padded">
            ...
            <p className="atlas-body atlas-body--muted">
              {isZh
                ...
                : "A personal assistant — for your calendar, your memory, and the things you'd rather hand off. Name them."}
            </p>
            {error && <div className="atlas-error">{error}</div>}

            <div className="atlas-input-wrap">
              <div className="atlas-input-row">
                <span className="atlas-input-label">
                  {isZh ? "名字" : "NAME"}
                </span>
                <input
            ...
            >
              <span className="atlas-body">
                {isZh ? "定制声音 & 气质" : "Customise voice & temperament"}
              </span>
              ...
              <div className="atlas-options">
                ...
                <textarea
                  ...
                  placeholder={
                    isZh
                      ? "绝对不要做的事情（可留空）"
                      : "Things they should never do (optional)"
                  }
                />
              </div>
            )}
        ...
        <div className="atlas-screen-form atlas-screen-form--padded">
          ...
          <p className="atlas-body atlas-body--muted">
            {isZh
              ...
              : "A small constellation, charted in your name. From here it only grows — one orbit, one hire, one star at a time."}
          </p>
          ...
          <ul className="atlas-roster">
            <li>
              <span className="atlas-roster-mark" aria-hidden="true">
                ★
              </span>
              <span className="atlas-roster-label">
                {isZh ? "创始人" : "FOUNDER"}
              </span>
