  ...
  const steps: CompanyTourStep[] = useMemo(
    () => [
      ...
      },
      {
        ...
        body: isChinese
          ? "经验库沉淀团队私有经验供 AI 复用，Dashboard 看公司概况，OKR 用来设定和追踪目标。"
          : "Experience is the team’s curated knowledge base for AI reuse, Dashboard shows company activity, and OKR tracks goals.",
        pad: 8,
        radius: 14,
      },
      {
...
export default function Layout() {
  ...
  return (
    ...
    >
            ...
            >
              ...
              >
                {currentTenantLogoUrl ? (
                  <img src={currentTenantLogoUrl} alt="" />
                ) : (
      ...
      <main
        className={`main-content${isChatPage ? " chat-page" : ""}${isAgentSettingsPage ? " agent-settings-page" : ""}${isGroupsPage ? " groups-shell" : ""}`}
      >
        <Outlet
