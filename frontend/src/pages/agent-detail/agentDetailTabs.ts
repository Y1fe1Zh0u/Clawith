...
export function isAgentDetailTab(
  value: string | null | undefined,
): value is AgentDetailTab {
  return !!value && AGENT_DETAIL_TABS.includes(value as AgentDetailTab);
}

export function isAgentDetailSettingsTab(
  value: string | null | undefined,
): value is AgentDetailTab {
  return (
    !!value && AGENT_DETAIL_SETTINGS_TABS.includes(value as AgentDetailTab)
  );
}
