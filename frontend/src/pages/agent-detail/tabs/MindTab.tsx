    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      <div>
        ...
        >
          {t(
            "agent.mind.soulDesc",
            "Core identity, personality, and behavior boundaries.",
          )}
        </p>
        <FileBrowser
          api={adapter}
      ...
      <div>
        ...
        >
          {t(
            "agent.mind.memoryDesc",
            "Persistent memory accumulated through conversations and experiences.",
          )}
        </p>
      ...
      <div>
        ...
        >
          <IconHeartbeat size={18} stroke={1.8} />{" "}
        ...
        >
          {t(
            "agent.mind.heartbeatDesc",
            "Instructions for periodic awareness checks. The agent reads this file during each heartbeat.",
          )}
        </p>
        <FileBrowser
          api={adapter}
          singleFile="HEARTBEAT.md"
          title=""
          features={{ edit: canEdit }}
        />
      </div>
