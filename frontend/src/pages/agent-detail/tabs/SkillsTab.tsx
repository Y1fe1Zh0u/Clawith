    ...
    <div>
      <div style={{ marginBottom: "16px" }}>
        ...
        >
          ...
          <br />• <code>skills/my-skill/SKILL.md</code> —{" "}
          {t(
            "agent.skills.folderFormat",
            "Each skill is a folder with a SKILL.md file and optional auxiliary files (scripts/, examples/)",
          )}
        </div>
      </div>
      ...
      <FileBrowser
        ...
        title={t("agent.skills.skillFiles")}
      />
      ...
      {showAgentClawhub && (
        ...
        >
          ...
          >
            ...
            >
              Search and install skills from ClawHub directly into this
              agent&apos;s workspace.
            </p>
            ...
            <div style={{ flex: 1, overflowY: "auto" }}>
              ...
              {agentClawhubResults.map((result) => (
                ...
                >
                  ...
                  >
                    {agentClawhubInstalling === result.slug
                      ? "Installing..."
                      : "Install"}
                  </button>
                </div>
      ...
      {showAgentUrlImport && (
        ...
        >
          ...
          >
            ...
            >
              Paste a GitHub URL pointing to a skill directory (must contain
              SKILL.md).
            </p>
            <input
              className="input"
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    toast.success(
                      t("common.file.filesImported", {
                        count: response.files_written,
                      }),
                    );
                    queryClient.invalidateQueries({
                      queryKey: ["files", agentId, "skills"],
      ...
      {showImportSkillModal && (
        ...
        >
          ...
          >
            ...
            >
              {t(
                "agent.skills.importDesc",
                "Select a preset skill to import into this agent. All skill files will be copied to the agent's skills folder.",
              )}
            </p>
            <div style={{ flex: 1, overflowY: "auto" }}>
              {!globalSkillsForImport ? (
                  ...
                  >
                    ...
                    >
                      {importingSkillId === skill.id ? (
                        ...
                        <>
                          <IconDownload size={13} stroke={1.8} /> Import
                        </>
                      )}
                    </button>
                  </div>
