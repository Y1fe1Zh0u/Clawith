  ...
  return (
    <div>
      ...
      <div className="card" style={{ marginBottom: "12px" }}>
        <h4 style={{ marginBottom: "4px" }}>API Key</h4>
        <p
          style={{
            fontSize: "12px",
          ...
          return (
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              >
                {hasConfiguredKey
                  ? isChinese
                    ? "密钥已配置。为安全起见，无法再次显示明文。"
                    : "A key is configured. Its plaintext cannot be shown again for security."
                  : isChinese
                    ? "未生成"
                    : "Not generated"}
              </div>
            ...
            >
              ...
              <div>
                ...
                >
                  {scope === "company" &&
                    t(
                      "agent.settings.perm.companyWideDesc",
                      "All platform users and agents can use it; Plaza is enabled",
                    )}
                  {scope === "private" &&
                    t(
                      "agent.settings.perm.onlyMeDesc",
          ...
          >
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              {[
                {
                  val: "use",
                  label: t("agent.settings.perm.useAccess", "Use"),
                  desc: t(
                ...
                {
                  val: "manage",
                  label: t("agent.settings.perm.manageAccess", "Manage"),
                  desc: t(
