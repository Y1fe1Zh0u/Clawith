...
const ZH: Record<string, TemplateLocale> = {
  ...
  "Project Manager": {
    ...
    bullets: ["项目规划与里程碑", "状态报告与仪表盘", "跨团队协调"],
  },
  "Chief of Staff": {
    name: "幕僚长",
    description:
      "你的私人幕僚长 —— 每日简报、优先级分诊、跟进追踪、用你的语气拟稿。",
    bullets: [
      "每日简报 —— 一分钟读完今天最要紧的事",
  ...
  "Frontend Developer": {
    name: "前端开发工程师",
    description:
      "构建响应式、无障碍的 Web 界面 —— React/Vue 组件、Core Web Vitals 优化、像素级实现。",
    bullets: [
  ...
  "Backend Architect": {
    name: "后端架构师",
    description:
      "设计撑得住的 API、数据模型和服务边界 —— 一致性、延迟、运维成本的取舍都摊在桌上。",
    bullets: [
  ...
  "Code Reviewer": {
    name: "代码审查员",
    description:
      "像资深工程师一样读 diff —— 抓正确性、安全、可维护性问题,跳过 bikeshedding。",
    bullets: [
      "正确性 & 边界情况 —— 月底凌晨什么会出岔子",
      "安全 —— OWASP 级问题在生产前抓住",
      '可维护性 —— 标记下任读不懂的"聪明代码"',
  ...
  "Rapid Prototyper": {
    name: "快速原型工程师",
    description:
      '把想法变成几小时就能点的 demo —— 在你下重注前先让你"摸到"产品。',
    bullets: [
  ...
  Designer: {
    ...
    bullets: ["从需求出设计简报", "设计系统维护", "竞品 UI 分析"],
  },
  "Product Intern": {
    name: "产品实习生",
    description: "协助产品经理做需求分析、竞品研究、用户反馈分析和文档整理。",
    bullets: ["需求 & PRD 支持", "用户反馈分类", "竞品研究"],
  },
  ...
  "Growth Hacker": {
    name: "增长黑客",
    description:
      "设计增长实验、分析漏斗、挖掘获客循环 —— 推动真指标,不是虚荣数字。",
    bullets: [
      "漏斗诊断 —— 找到那个最关键的漏点",
  ...
  "Content Creator": {
    name: "内容创作者",
    description:
      "把想法变成跨平台内容 —— 编辑日历、博客、Newsletter、社媒文案,口吻像你的品牌。",
    bullets: [
      "编辑日历 —— 月度主题 + 各渠道具体选题",
  ...
  "SEO Specialist": {
    name: "SEO 专家",
    description:
      "通过关键词策略、技术 SEO 审计、基于搜索意图的内容简报来增长自然搜索流量。",
    bullets: [
      "关键词地图 —— 按意图聚类、按机会值排序",
  ...
  "LinkedIn Content Creator": {
    name: "LinkedIn 内容创作者",
    description:
      "在 LinkedIn 上打造个人品牌和 B2B 思想领导力 —— 真有人读、真愿意转的帖子。",
    bullets: [
      "个人品牌口吻 —— 具体、有观点、可信度优先",
  ...
  "Market Researcher": {
    ...
    bullets: ["行业 & 趋势分析", "竞争情报追踪", "结构化研究报告"],
  },
  ...
  "Market Intel Aggregator": {
    name: "市场情报聚合器",
    description:
      "每日财经情报 —— 扫全球新闻,把信号从噪音里筛出来,5 分钟读完今天对你盘面真有影响的事。",
    bullets: [
  ...
  "Watchlist Monitor": {
    name: "盯盘助手",
    description:
      "盘中盯你的标的:抓有意义的价格变化、关键位突破、可命名催化剂 —— 闭市自动安静。",
    bullets: [
  ...
  "Technical Analyst": {
    name: "技术分析师",
    description:
      "老实读图:当前形态、关键位、可能演化、还有让这个判断作废的失效条件。",
    bullets: [
      "看图 —— 趋势、结构、关键位、指标共振",
      "形态框定 —— 多条路径 + 明确的失效条件",
  ...
  "Risk Manager": {
    name: "风险管理员",
    description:
      "每个交易想法的看门人。Stage 你的想法 → 跑 guards → 拿 GREEN/YELLOW/RED → 你来决定要不要发。",
    bullets: [
      "交易暂存 —— 在动手前先把想法写下来",
  ...
  "Trading Journal Coach": {
    name: "交易日志教练",
    description:
      "读你过去的交易、找重复犯的错、提议规则 —— 跟 Risk Manager 形成闭环,让你越来越好。",
    bullets: [
  ...
  "Earnings & Filings Analyst": {
    name: "财报与公告分析师",
    description:
      "读季报、8-K、电话会纪要 —— 提炼经营、风险、估值锚相对上期的变化。",
    bullets: [
  ...
  "COT Report Analyst": {
    name: "COT 持仓分析师",
    description:
      "读 CFTC 周度持仓报告 —— 跟踪商业 vs 投机持仓,标出历史上反转之前的极端位置。",
    bullets: [
  ...
  "Pre-Market & Open Briefer": {
    name: "盘前简报员",
    description:
      "美股交易日早 8 点 ET 的一屏简报:隔夜要闻、期指、关键合约、财报、数据 —— 开盘前你需要知道的。",
    bullets: [
      "隔夜摘要 —— 亚欧收盘、关键头条、期指水平",
  ...
  "Tilt & Bias Coach": {
    name: "心态与偏差教练",
    description:
      "帮你检查现在适不适合交易。在你做出报复性、FOMO、过度仓位、疲劳决策之前抓住你。",
    bullets: [
      '盘前自检 —— "我现在该不该做交易"诊断',
      "偏差识别 —— 给你正在踩的认知陷阱命名",
      "行为干预 —— 状态不对时的具体行动建议",
